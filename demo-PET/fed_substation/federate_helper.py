...
class FEDERATE_HELPER:
    ...
    def create_federate(self):
        self.hFed = helics.helicsCreateValueFederateFromConfig(config_file: self.helicsConfig) #(self.helics_config)  #(self.helicsConfig) # the helics period is 15 seconds
...
class CURVES_TO_PLOT:
    def __init__(self, num_prosumers):
        ...
        self.basepoint_mean = []
        self.curve_basepoint_mean = []

        self.setpoint_mean = []
        self.curve_setpoint_mean = []

        self.hvac_load_mean = []
        self.curve_hvac_load_mean = []

        self.hvac_load_max = []
        self.curve_hvac_load_max = []

        self.hvac_load_min = []
        self.curve_hvac_load_min = []

        self.house_unres_mean = []
        self.curve_house_unres_mean = []

        self.house_unres_max = []
        self.curve_house_unres_max = []

        self.house_unres_min = []
        self.curve_house_unres_min = []
        ...
        self.hvac_on_ratio = []
        self.curve_hvac_on_ratio = []

        self.seller_ratio = []
        self.curve_seller_ratio = []

        self.buyer_ratio = []
        self.curve_buyer_ratio = []

        self.nontcp_ratio = []
        self.curve_nontcp_ratio = []
