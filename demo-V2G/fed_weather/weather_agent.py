...
def startWeatherAgent(datafile, configfile):
    ...
    weatherData = pd.read_csv(datafile, index_col=0, parse_dates=True)
...
def usage():
    print("usage: python weather_agent.py <input weather file full path>")
